// <copyright file="IntegerValue.cs" company="Honeywell | Safety and Productivity Solutions">
...
/// <summary>
/// Question to be answered with an integer value.
/// </summary>
public class IntegerValue : QuestionWithValueTypeAnswer<int>
{
    /// <inheritdoc/>
    public override sealed string Type => "number";
    ...
    public override void BuildDialog(IDevice device, InstructionSet instr, string id, string? previousCode)
    {
        ...
        instr.GetDigits(Vars.ANSWER, Prompt, AdditionalInformation, confirmationPrompt: confirmationPrompt, minLength: minLength, maxLength: maxLength, minRange: minRange, maxRange: maxRange, barcodeEnabled: ScannerEnabled, imageUrl: Image?.AbsoluteUri);
