...
/// <summary>
/// Base implementation for AppConnector to be used with GWS Connector App. All implementations of Checklist (SqlServer) connectors implementations must inherit from this base class.
/// </summary>
    ...
    where TWorkflow : class, IWorkflow
{
    ...
    /// <inheritdoc/>
    public override string ConnectorName => "SqlServer";
    ...
    public override void RegisterServices()
    {
        ...
        Context.Container.Register<IDbDataSetParser, DbDataSetParser>();
    }
}

/// <summary>
/// An implementation for AppConnector for GWS-Workflows - Checklist (SqlServer) to be used with GWS Connector App.
/// </summary>
