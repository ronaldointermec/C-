...
namespace Honeywell.GWS.Connector.Library.Workflows.Checklist.SqlServer.Tests;
...
public sealed class BehaviorTests : IDisposable
{
    ...
    public void GetOperator_WithRows_ReturnsOperator()
    {
        ...
        if (res != null)
        {
            ...
            res.Password.Should().Be(string.Empty);
        }
    }
    ...
    public void RetrieveChecklist()
    {
        ...
        if (res != null)
        {
            ...
            Assert.Collection(res.Questions,
                q1 => { var m = Assert.IsType<Message>(q1); m.Image.Should().NotBeNull(); m.EndTime.Should().BeNull(); },
                q2 => { var a = Assert.IsType<Ask>(q2); a.Image.Should().NotBeNull(); a.EndTime.Should().NotBeNull(); },
    ...
    public void UpdateChecklist_Complete_CheckCommands_Ok()
    {
        ...
        dataParameterCollection.Verify(x => x.Add(It.Is<SqlParameter>(x => x.ParameterName == "operator" && x.Value.Equals(oper))));
        dataParameterCollection.Verify(x => x.Add(It.Is<SqlParameter>(x => x.ParameterName == "checklistId" && x.Value.Equals("1"))));
        dataParameterCollection.Verify(x => x.Add(It.Is<SqlParameter>(x => x.ParameterName == "completedAt" && x.Value.Equals(new DateTime(2022, 10, 24, 10, 0, 0)))));
    ...
    [Fact]
    public void UpdateChecklist_Update_CheckCommands()
    {
        var connMock = new Mock<IDbConnection>();
        var cmdMock = new Mock<IDbCommand>();
        ...
        dataParameterCollection.Verify(x => x.Add(It.Is<SqlParameter>(x => x.ParameterName == "start" && x.Value.Equals(new DateTime(2022, 10, 24, 10, 0, 0)))));
        dataParameterCollection.Verify(x => x.Add(It.Is<SqlParameter>(x => x.ParameterName == "end" && x.Value.Equals(new DateTime(2022, 10, 24, 10, 0, 0)))));
        dataParameterCollection.Verify(x => x.Add(It.Is<SqlParameter>(x => x.ParameterName == "answer" && x.Value.Equals(new DateTime(2022, 10, 24).ToString()))));
    ...
    private static DataTable GetQuestionsDataTable()
    {
        ...
        dr2["EndTime"] = new DateTime(2022, 10, 24, 10, 1, 0).ToString();
        dt.Rows.Add(dr2);
