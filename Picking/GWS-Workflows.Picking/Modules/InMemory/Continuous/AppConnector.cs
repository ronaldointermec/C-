...
/// <summary>
/// An implementation for ServiceConnector for GWS-Workflows - Picking (Memory Continuous) to be used with GWS Connector App.
/// </summary>
public class AppConnector : ConnectorBase<Behavior, PickingBehaviorSettings, Workflow>
{
    ...
    /// <inheritdoc/>
    public override string ConnectorName => "Memory Continuous";
}
#endif