...
/// <summary>
/// Base implementation for AppConnector to be used with GWS Connector App. All implementations of Picking (SqlServer Continuous) connectors implementations must inherit from this base class.
/// </summary>
    ...
    where TWorkflow : class, IWorkflow
{
    ...
    /// <inheritdoc/>
    public override string ConnectorName => "SqlServer Continuous";
...
/// <summary>
/// An implementation for AppConnector for GWS-Workflows - Picking (SqlServer Continuous) to be used with GWS Connector App.
/// </summary>
