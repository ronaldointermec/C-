...
/// <summary>
/// Base implementation for AppConnector to be used with GWS Connector App. All implementations of Picking (SqlServer Batch) connectors implementations must inherit from this base class.
/// </summary>
    ...
    where TWorkflow : class, IWorkflow
{
    ...
    /// <inheritdoc/>
    public override string ConnectorName => "SqlServer Batch";
...
/// <summary>
/// An implementation for AppConnector for GWS-Workflows - Picking (SqlServer Batch) to be used with GWS Connector App.
/// </summary>
