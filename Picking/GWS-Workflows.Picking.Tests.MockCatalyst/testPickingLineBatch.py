...
class Test(VioBaseTestCase):
    ...
    def test01PickingLine(self):
        ...
        self.validate_prompts(
            ...
            , '01' # Pending command
            , 'test 1.1' # (1.1) Pronounce the product name
            , '3 boxes'
            ...
            , 'Slot A'
            , 'VCOMMAND02, correct?'
            , 'Place in dock' # (1.9) Test end pallet
            , 'How many labels?'
            , 'Correct printing?'
            , 'Pallet location'
            , 'Pallet placed'
            , 'Aisle 3' # (1.9) Confirm line quantity
            , 'Slot A'
            , '05'
            , '4 boxes'
            , 'Place in dock' # (1.10) Test placing in dock with dock informed
            , 'How many labels?'
            , 'Correct printing?'
            , 'Dock 1'
            , 'Place in dock' # (1.11) Test placing in dock without dock informed
            , 'How many labels?'
            , 'Correct printing?'
            , 'Specify destination'
            , 'Place in dock'
            , 'How many labels?'
            , 'VCOMMAND01, correct?' # (1.12) Test declaring exception in dock
            , 'This is a question' # Say yes
            , 'This is another question' # Say no
            , 'Order 001 , Customer , in container'
